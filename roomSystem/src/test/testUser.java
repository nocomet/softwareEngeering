...
public class testUser {
	public static void main(String[] args)
	{
		...
		personalUser hysung22=new personalUser("1","1","노혜성","010-4949-7193");
		...
		companyUser hysung44=new companyUser("2","2","지재민","010-1234-1234","111-1234567");
		...
		list.addUser(hysung22);
		list.addUser(hysung44);
