...
public class C_JoincPage extends JPanel {
	...
	private String[] address = { "naver.com",  "google.co.kr", "hanmail.net"};
	private String seleted_addr;
	...
	public C_JoincPage() {
		...
		lblEmail.setForeground(new Color(44, 62, 30));
		lblEmail.setFont(new Font("돋움", Font.PLAIN, 12));
		lblEmail.setBounds(170, 108, 63, 30);
		add(lblEmail);
		
		email_txt = new JTextField();
		email_txt.setBounds(245, 108, 100, 30);
		email_txt.setColumns(5);
		add(email_txt);
		...
		btnMenu.setBounds(80, 380, 215, 47);
		...
		btnJoin.setBounds(405, 380, 215, 47);
