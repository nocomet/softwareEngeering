...
public class startRoomFile{		
	...
	{		
		...
		list.addRoom(new conferenceRoom("자취방 회의실", "대구 광역시", "북구", "30", "10", "노혜성","nxsung@naver.com",3,new ImageIcon("./src/사진1.jpg")));		
		...
		list.addRoom(new conferenceRoom("경산의 땅", "대구 광역시", "달성구", "25", "15", "이신영","lsy8795@gmail.com",6,new ImageIcon("./src/사진2.jpg")));		
